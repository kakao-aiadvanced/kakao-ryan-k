...
tavily = TavilyClient(api_key='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')
...
def relevant_documents(state):
    ...
    for d in documents:
        ...
        # Document not relevant
            ...
            relevant = "Yes"
            continue
    return {"documents": filtered_docs, "question": question, "relevant": relevant}
...
# Define the nodes
workflow.add_node("web_bsearch", web_search)  # web search
